...
export function ClientOperationsControl({ clientId, initial, owners, canManage }: Props) {
  ...
  const reviewLabel = brief.nextReviewAt
    ? stableUkDateString(new Intl.DateTimeFormat("en-GB", { day: "numeric", month: "short", year: "numeric", timeZone: "Europe/London" }).format(brief.nextReviewAt))
    : "Not scheduled";
