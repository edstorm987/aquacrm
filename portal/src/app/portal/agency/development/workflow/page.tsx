...
export default async function DevelopmentWorkflowPage() {
  ...
  return <div className="mx-auto flex w-full max-w-7xl flex-col gap-7"><DevelopmentNav active="workflow" /><DevelopmentToolkitWorkspace mode="workflow" initialResources={data.resources} initialTotal={data.total} initialCategories={data.categories} initialWorkflows={data.workflows} sops={data.sops} technicalAccessLevel={data.technicalAccessLevel} /></div>;
}
