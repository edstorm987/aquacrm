...
export function DayBriefingPanel({ radar, radarPaused = false, recommendations, counts, reviewedAt, advisorConfigured, advisorBusy, taskSummary, taskBusyId, canAcceptActions, onGenerate, onAccept, onOpenAdvisor }: {
