  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* One app, several companies: which one am I operating as. The portal
            layout provides the membership-filtered options and this renders
            nothing unless there is actually somewhere else to move. */}
