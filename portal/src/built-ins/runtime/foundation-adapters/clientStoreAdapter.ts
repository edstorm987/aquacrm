...
// `ClientStorePort` from `@/built-ins/runtime/_types`. Plugins (incl. T2's
// fulfillment) consume the port; never the underlying module.

import * as tenants from "@/server/tenants";
import type { ClientStorePort, CreateClientInput, UpdateClientPatch } from "@/built-ins/runtime/_types";
