        ...
        fields: [
          {
            ...
            type: "select",
            default: "aqua-epic-intro",
            options: [
              { value: "aqua-epic-intro", label: "Epic Intro" },
              { value: "aqua-blueprint", label: "Blueprint Setup" },
              { value: "aqua-diagnostics", label: "Diagnostics / Foundations" },
              { value: "aqua-brand-builder", label: "Brand Builder + Verification" },
              { value: "aqua-traffic", label: "Traffic (Expansion Plan)" },
              { value: "aqua-mastery", label: "Mastery & Ascension" },
            ],
            helpText: "Used when a client-creation request does not explicitly choose a phase.",
          },
          {
            ...
            type: "boolean",
            default: true,
            helpText: "When off, authorised agency users can advance with open tasks (logged to activity).",
          },
        ],
      },
    ],
