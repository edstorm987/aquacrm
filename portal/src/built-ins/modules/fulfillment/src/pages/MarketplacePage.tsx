// Legacy `/portal/agency/fulfillment/marketplace?client=<clientId>` surface.
//
  ...
  if (!queryClientId) {
    return (
      <section className="fulfillment-marketplace">
        <h1>Client tools</h1>
        <p>
          Pick a client first. Client tools are managed from the client workspace.
        </p>
        <p>
          <a href="/portal/clients">Choose a client →</a>
        </p>
      </section>
    );
  }
