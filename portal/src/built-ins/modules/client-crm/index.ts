        ...
        fields: [
          {
            ...
            type: "boolean",
            default: true,
            helpText: "When on, a signed-in end-customer with no Contact gets one created from their account the first time they open their profile; when off, only an existing Contact is linked.",
          },
          {
            id: "defaultTags",
            ...
            type: "text",
            default: "",
            helpText: "Applied to a Contact created without tags of its own — manual, signup or order. Blank applies none.",
          },
        ],
      },
    ],
