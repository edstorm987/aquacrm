...
// the core one at `/portal/agency/people`. Finance now reads only `people.ts`,
// so the plugin copy could only ever drift stale — an operator adding
...
//
// Departments / Roles / Settings remain HR-owned. Leave and Employees stay
// mounted as HR-specific views over the canonical People workforce ledgers.
