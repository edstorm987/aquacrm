...
const AQUA_INCUBATOR_COVER = "/aqua-incubator/cover-roots.svg";
const AQUA_INCUBATOR_ICON = "/aqua-incubator/icon-incubator.svg";
const AQUA_INCUBATOR_CARD_COVER = "/aqua-incubator/card-cover.svg";
