export type IntegrationProvider = "resend" | "smtp" | "twilio" | "meta" | "stripe" | "github" | "vercel" | "openai" | "aqua-editor-ai" | "aqua-embed" | "google-search-console" | "client-supabase";
...
export const INTEGRATION_CATALOG: IntegrationDefinition[] = [
  {
    id: "aqua-embed",
    name: "Aqua embed credential",
    category: "Development",
    description: "Issue a separately revocable, workspace- or client-scoped credential for a trusted portal server.",
    setupUrl: "/portal/agency/settings#connections",
    setupLabel: "Manage in AquaCRM",
    outcome: "The generated bearer is revealed once; later reads show only its fingerprint, scope and policy.",
    fields: [
      { id: "credentialSecret", label: "Generated bearer", kind: "password", secret: true, required: true, help: "Generated by AquaCRM and encrypted in the credential vault." },
      { id: "credentialDigest", label: "Credential digest", kind: "text", required: true, help: "One-way lookup digest; never the bearer." },
      { id: "fingerprint", label: "Fingerprint", kind: "text", required: true, help: "Short non-secret identifier shown in Settings." },
      { id: "maxMode", label: "Maximum mode", kind: "text", required: true, help: "Client or admin. Client-scoped credentials are always client-only." },
      { id: "allowedOrigin", label: "Allowed origin", kind: "url", help: "Optional exact Origin/Referer binding enforced at consumption." },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      { id: "affiliateConnectWebhookSecret", label: "Affiliate Connect webhook secret", kind: "password", secret: true, placeholder: "whsec_...", help: "The signing secret for the separate /api/portal/affiliates/webhooks/stripe Connect endpoint. Never reuse the Ecommerce checkout endpoint secret." },
    ],
  },
  {
    id: "github",
