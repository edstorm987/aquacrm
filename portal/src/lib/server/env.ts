...
export const ENV_ALLOWLIST: readonly string[] = [
  ...
  "ENQUIRY_NOTIFY_TO",
  "ENQUIRY_EMAIL_FROM",
  "PUBLIC_BRAND_ORIGINS",
  "MILESYMEDIA_FROM_EMAIL",
  "MILESYMEDIA_FROM_NAME",
  "MILESYMEDIA_REPLY_TO",
...
const PORTAL_KEY_PATTERN = /^(PORTAL_|FOUNDER_|GITHUB_|NEXT_PUBLIC_PORTAL_|NEXT_PUBLIC_SUPABASE_|SUPABASE_|NEXT_PUBLIC_SENTRY|SENTRY_|VERCEL_|GOOGLE_OAUTH_|RESEND_|ENQUIRY_|MILESYMEDIA_|BLOB_|STRIPE_|OPENAI_)/;
