...
import { DEFAULT_ROLES } from "@/built-ins/modules/agency-hr/src/server/roles";
import { ALL_PERMISSION_KEYS } from "@/built-ins/modules/agency-hr/src/lib/domain";
import type { PermissionKey } from "@/built-ins/modules/agency-hr/src/lib/domain";
