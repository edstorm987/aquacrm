...
// Archived: Milesymedia now runs as a single bespoke agency workspace.
  ...
  return (
    <div ref={wrapRef} className="relative" data-testid="tenant-switcher">
      <button
        ...
        aria-haspopup="menu"
        aria-expanded={open}
        aria-label={`Active business: ${active.name}. Click to switch.`}
      ...
      >
        ...
        <span className="min-w-0 flex-1">
          <span className="block truncate text-[10px] font-medium uppercase tracking-wider text-black/45">Business</span>
      ...
      {open && (
        ...
        >
          ...
          <div className="max-h-72 overflow-y-auto px-2 py-2">
            <div className="px-1 pb-1 text-[10px] font-semibold uppercase tracking-wider text-black/40">Your businesses</div>
            {filtered.length === 0 && (
              ...
              <form onSubmit={onAdd} className="space-y-2 p-1">
                ...
                <div className="flex justify-end gap-2">
                  ...
                  <button type="submit" disabled={busy || !newName.trim()}
                    className="rounded-md bg-brand px-3 py-1.5 text-xs font-medium text-white shadow hover:opacity-90 disabled:opacity-60">
