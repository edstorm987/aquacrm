...
The complete enumeration of the Radar catalogue: **172 signal families × 12 lenses = 2064 rules**. Generated from `src/lib/radarRuleCatalog.ts` by `scripts/generate-radar-rules-reference.ts` — re-run after editing the catalogue.
