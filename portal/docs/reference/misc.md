...
- `isCrossOriginBrowserMutation(input: { method: string; path: string; origin: string | null; host: string | null; }): boolean`
- `proxy(req: NextRequest)`
- `config = {`

**Depends on (3):** [`src/lib/server/auth/sessionToken.ts`](lib.md#file-src-lib-server-auth-sessiontoken-ts-b0b933a575) · [`src/lib/server/embedFramePolicy.ts`](lib.md#file-src-lib-server-embedframepolicy-ts-dc90dfc76e) · [`src/lib/staffWorkspacePolicy.ts`](lib.md#file-src-lib-staffworkspacepolicy-ts-3b2d90ae3d)
