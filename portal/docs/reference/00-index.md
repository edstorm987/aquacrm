...
- **2711** files · **9372** exported symbols.
...
- [Shared logic — `src/lib/`](lib.md) — 371 files, 2466 symbols
...
- [App routes & UI — `src/app/`](app.md) — 662 files, 1271 symbols
- [Scripts — `scripts/`](scripts.md) — 616 files, 26 symbols
