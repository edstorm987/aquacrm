...
- **2404** files · **8271** exported symbols.
...
- [Shared logic — `src/lib/`](lib.md) — 286 files, 1852 symbols
- [Shared components — `src/components/`](components.md) — 114 files, 283 symbols
- [Plugins — `src/built-ins/`](built-ins.md) — 747 files, 3262 symbols
- [App routes & UI — `src/app/`](app.md) — 612 files, 1119 symbols
- [Scripts — `scripts/`](scripts.md) — 491 files, 26 symbols
