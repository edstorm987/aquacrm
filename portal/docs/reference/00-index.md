...
- **2693** files · **9322** exported symbols.

- **8** large source-reference volumes · **1** master file index · **0** per-source Markdown stubs.

## Volumes

- [Engines — `src/engines/`](engines.md) — 86 files, 723 symbols
- [State layer — `src/server/`](server.md) — 72 files, 1159 symbols
- [Shared logic — `src/lib/`](lib.md) — 366 files, 2444 symbols
- [Shared components — `src/components/`](components.md) — 128 files, 316 symbols
- [Plugins — `src/built-ins/`](built-ins.md) — 768 files, 3375 symbols
- [App routes & UI — `src/app/`](app.md) — 661 files, 1268 symbols
- [Scripts — `scripts/`](scripts.md) — 606 files, 26 symbols
