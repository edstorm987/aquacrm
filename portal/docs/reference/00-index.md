...
- **2388** files · **8262** exported symbols.
...
- [State layer — `src/server/`](server.md) — 66 files, 1046 symbols
- [Shared logic — `src/lib/`](lib.md) — 282 files, 1839 symbols
- [Shared components — `src/components/`](components.md) — 113 files, 280 symbols
- [Plugins — `src/built-ins/`](built-ins.md) — 747 files, 3276 symbols
- [App routes & UI — `src/app/`](app.md) — 611 files, 1118 symbols
- [Scripts — `scripts/`](scripts.md) — 481 files, 26 symbols
