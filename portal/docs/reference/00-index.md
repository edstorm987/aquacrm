...
- **2701** files · **9357** exported symbols.
...
- [Shared logic — `src/lib/`](lib.md) — 367 files, 2452 symbols
...
- [App routes & UI — `src/app/`](app.md) — 661 files, 1270 symbols
- [Scripts — `scripts/`](scripts.md) — 611 files, 26 symbols
