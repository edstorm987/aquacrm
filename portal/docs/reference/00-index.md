...
- **1899** files · **6603** exported symbols.

## Files

- [State layer — `src/server/`](server.md) — 57 files, 833 symbols
- [Shared logic — `src/lib/`](lib.md) — 257 files, 1665 symbols
...
- [App routes & UI — `src/app/`](app.md) — 534 files, 958 symbols
- [Scripts — `scripts/`](scripts.md) — 258 files, 8 symbols
