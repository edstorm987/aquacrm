...
- **2848** files · **9792** exported symbols.
...
- [Shared logic — `src/lib/`](lib.md) — 401 files, 2700 symbols
- [Shared components — `src/components/`](components.md) — 132 files, 324 symbols
- [Plugins — `src/built-ins/`](built-ins.md) — 775 files, 3448 symbols
- [App routes & UI — `src/app/`](app.md) — 686 files, 1317 symbols
- [Scripts — `scripts/`](scripts.md) — 683 files, 26 symbols
