...
- **2661** files · **9169** exported symbols.
...
- [State layer — `src/server/`](server.md) — 72 files, 1153 symbols
- [Shared logic — `src/lib/`](lib.md) — 354 files, 2323 symbols
- [Shared components — `src/components/`](components.md) — 127 files, 314 symbols
- [Plugins — `src/built-ins/`](built-ins.md) — 765 files, 3363 symbols
- [App routes & UI — `src/app/`](app.md) — 659 files, 1266 symbols
- [Scripts — `scripts/`](scripts.md) — 593 files, 26 symbols
