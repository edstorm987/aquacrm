...
- **2705** files · **9364** exported symbols.
...
- [Shared logic — `src/lib/`](lib.md) — 368 files, 2460 symbols
...
- [App routes & UI — `src/app/`](app.md) — 661 files, 1269 symbols
- [Scripts — `scripts/`](scripts.md) — 614 files, 26 symbols
