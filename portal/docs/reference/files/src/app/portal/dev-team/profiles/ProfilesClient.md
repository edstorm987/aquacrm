# `src/app/portal/dev-team/profiles/ProfilesClient.tsx`
...
- `type Persona`
- `ProfilesClient({ active, currentPersona, }: { active: boolean; currentPersona: Persona | null; })`
...
- [`src/app/portal/dev-team/profiles/page.tsx`](./page.md)
