...
- [`src/lib/server/integrations/githubProjectPublisher.ts`](../integrations/githubProjectPublisher.md)
- [`src/lib/server/integrations/vercelProjectDeployer.ts`](../integrations/vercelProjectDeployer.md)
