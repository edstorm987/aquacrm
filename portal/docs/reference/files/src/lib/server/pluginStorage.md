...
- [`src/lib/server/auth/showcaseMode.ts`](./auth/showcaseMode.md)
- [`src/lib/server/brandPortfolioService.ts`](./brandPortfolioService.md)
- [`src/lib/server/clients/clientDelightExpense.ts`](./clients/clientDelightExpense.md)
- [`src/lib/server/commandIntelligenceService.ts`](./commandIntelligenceService.md)
- [`src/lib/server/commercialProposal.ts`](./commercialProposal.md)
- [`src/lib/server/finance/financeBudgetCampaigns.ts`](./finance/financeBudgetCampaigns.md)
- [`src/lib/server/finance/financeWorkforce.ts`](./finance/financeWorkforce.md)
- [`src/lib/server/inbox/operationalAlerts.ts`](./inbox/operationalAlerts.md)
- [`src/lib/server/seeds/demoSeed.ts`](./seeds/demoSeed.md)
- [`src/lib/server/websiteEnquiryLeadSync.ts`](./websiteEnquiryLeadSync.md)
