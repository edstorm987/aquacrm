...
- `stepsFor(alertId: string, context: { who?: string; contact?: string; amount?: string; when?: string; href?: string } = {}): EvidenceStep[]`

## Depends on (1)

- [`src/lib/inbox/resolutionEvidence.ts`](./resolutionEvidence.md)
