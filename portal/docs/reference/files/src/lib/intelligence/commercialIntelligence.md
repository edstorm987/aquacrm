...
- `buildCommercialIntelligence({ leads, clients, campaigns, pipeline, cards, currency, pageviews, forms, pageviewsMeasured = true, formsMeasured = true, now = Date.now(), }: BuildCommercialIntelligenceInput): CommercialIntelligenceSnapshotWit…`
