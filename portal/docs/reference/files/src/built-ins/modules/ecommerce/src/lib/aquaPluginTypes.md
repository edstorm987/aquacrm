...
- `interface PluginPage (5 members)`
...
- [`src/built-ins/modules/ecommerce/src/lib/tenancy.ts`](./tenancy.md)

## Used by (16)

- [`src/built-ins/modules/ecommerce/index.ts`](../../index.md)
- [`src/built-ins/modules/ecommerce/src/api/handlers.ts`](../api/handlers.md)
- [`src/built-ins/modules/ecommerce/src/api/routes.ts`](../api/routes.md)
- [`src/built-ins/modules/ecommerce/src/pages/CollectionsPage.tsx`](../pages/CollectionsPage.md)
...
- [`src/built-ins/modules/ecommerce/src/pages/ProductNewPage.tsx`](../pages/ProductNewPage.md)
