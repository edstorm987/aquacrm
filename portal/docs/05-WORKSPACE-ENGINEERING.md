...
>
> Consolidated 2026-09-12 from **23** source documents / **59,745 words**. Each source is retained verbatim between provenance markers. The original path remains alongside it because relative links and runtime-backed Dev Team records still resolve from that location during the compatibility phase.
...
- [`docs/workspace/api-reference.md`](#source-docs-workspace-api-reference-md) — 8,945 words · `99551a0db0ec`
...
- [`docs/workspace/feature-index.md`](#source-docs-workspace-feature-index-md) — 5,464 words · `bb43a5672f29`
...
<!-- AQUACRM_SOURCE_START path="docs/workspace/api-reference.md" sha256="99551a0db0eccd7a55daf0ba463b031a28d6f464cf320c95e53bc0f264845e4d" -->
...
| `/api/portal/governance/subject-access` | POST / PUT / PATCH | GDPR Art. 15/20 staged safe JSON export (owner/manager). Every body is bounded and binds an exact same-agency identity-verified access/portability request. POST enumerates every enumerable hydrated state entry (including required lazy sidecars); malformed recognised rows/nested history, accessors and cap exhaustion block preparation, while typed owner/scope vetoes and explicit measured projections produce a reviewable safe subset. PUT binds human-review evidence to one agency/request/person/digest/result identity, returns the same result id for an exact replay, and rejects changed or cross-request reuse. PATCH independently binds delivery evidence and fulfils; stored requests are descriptor-read/accessor-refused, transitions are atomic with activity, and every response is no-store. Scope excludes client-owned/provider stores and still requires manual/legal completion. | agency | new 2026-08-28; hardened 2026-09-12 |
...
<!-- AQUACRM_SOURCE_START path="docs/workspace/feature-index.md" sha256="bb43a5672f29ee2dac26fe19a29d5506bed5a042c9c644ec7b94ed9e5c213f95" -->
