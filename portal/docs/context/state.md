...
- **First git commit** — months uncommitted; Ed’s call. **The only open launch blocker** ([checklist.md](../development/checklist.md) agrees). A push triggers Vercel → production, which is why it has waited.
