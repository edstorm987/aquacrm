...
**Status: BLOCKED — phases 1–4 shipped (2026-08-19), plus the channel consolidation (14 views → 10, Ed's call). Phase 5's people-map waits on a PostHog read-back (a dependency, not a decision). Phase 6's remaining question — collapse the 10 views to ~5? — is Ed's.**
...
6. ⛔ **Cohere** — BLOCKED on Ed: consolidate the 12 views (now 14 with pulse + radar) down to ~5, or keep them all?
...
## Decisions (Ed) — still open, phases 5–6 wait on them
- **Consolidate the views** — down to ~5 (pulse / radar / funnels / customers / channels), or keep all 14? Pulse and radar were added as new views precisely because they belong in *both* answers.
