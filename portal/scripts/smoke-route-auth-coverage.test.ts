...
const PUBLIC: Record<string, string> = {
  ...
  "public/aqua-tag-admission": "verifies exact managed proof for one registered tenant/site/host before minting a short-lived form admission; stores neither proof nor answers",
  "public/form-capture": "the Aqua Tag's signed-admission endpoint with durable new/replay/conflict classification before quotas or mutation",
  "public/aqua-tag-config": "serves the Tag's per-site config; no private data",
  "public/bot-challenge/config": "serves only the public managed-challenge site key and whether public forms must fail closed",
