...
const PUBLIC: Record<string, string> = {
  ...
  "public/aqua-tag-admission": "mints a short-lived exact form admission only for a registered site-key and Origin scope; locally rate-limited and stores nothing",
  "public/form-capture": "the Aqua Tag's signed-admission capture endpoint for registered sites",
