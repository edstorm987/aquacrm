...
test("every callable function is expected with its migration; trigger functions are not RPCs", () => {
  ...
  assert.ok(rpcs.size >= 27, `expected at least 27 callable functions, saw ${rpcs.size}`);
