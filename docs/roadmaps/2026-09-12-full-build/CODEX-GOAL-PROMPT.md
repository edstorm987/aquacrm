...
Railway, Supabase cloud, DNS, providers, real credentials/data, email/SMS/payments, deployment and applying migrations remain prohibited until Ed separately authorises the exact action. Local fixtures, isolated memory/file backends, disposable databases and 127.0.0.1 are allowed. Skip human-only keys/legal/provider actions, record them, and continue independent safe work. Keep heavy jobs serial with /private/tmp/aquacrm-heavy-job-20260912.lock and avoid sustained resource saturation.
