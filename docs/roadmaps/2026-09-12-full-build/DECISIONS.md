...
17. Ed explicitly instructed “don't do live” on 12 September 2026. No unattended or current-run Railway, Supabase, DNS, provider, production-data, deployment, push, or live-containment mutation is authorised. Read-only checks may be recorded, but no further live probing is needed for the local build programme.
